...
const resumeUrl = `${import.meta.env.BASE_URL}Cezar_Pedroso_Resume.pdf`;
...
export function Contact() {
  return (
    <section id="contact" className="py-24 pb-32">
      ...
      >
        <div className="mb-12 font-mono text-sm tracking-widest text-primary uppercase">
          04 Contact
        </div>
        ...
        <div className="flex flex-col space-y-6 pt-6 border-t border-border">
          ...
          <div className="flex flex-col sm:flex-row gap-6 sm:gap-10 pt-8 font-mono text-xs tracking-widest uppercase text-muted-foreground">
            ...
            <a
              href="https://linkedin.com/in/cezaramp"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-primary transition-colors hover:underline underline-offset-4 decoration-primary/50"
            ...
            <a
              href={resumeUrl}
              download="Cezar_Pedroso_Resume.pdf"
              className="hover:text-primary transition-colors hover:underline underline-offset-4 decoration-primary/50"
